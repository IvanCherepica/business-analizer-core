...
INSERT INTO db_schema.bizType (id, name) VALUES (3, 'салоны красоты | барбер шоп | парикмахерские | спа | маникюр | студия красоты | солярий');
INSERT INTO db_schema.bizType (id, name) VALUES (4, 'магазин | продукты');

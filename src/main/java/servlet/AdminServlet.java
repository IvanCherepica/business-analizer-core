...
public class AdminServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        pointDaoService.save(new Point("Озерки","Московский просп., 25/1",59.915585,30.317665,2));
        pointDaoService.save(new Point("ГорЗдрав","Бронницкая ул., 5",59.916293, 30.320225,2 ));
        pointDaoService.save(new Point("Софосбувир СПб", "Клинский просп., 21",59.914669, 30.321186,2 ));
        pointDaoService.save(new Point("Синофарм СПб Китайская медицина","наб. Обводного канала, 92, эт. 1, оф. 102-2",59.908638, 30.322031,2));
        pointDaoService.save(new Point("Петрофарм","Большая Конюшенная ул., 14",59.936341, 30.322866,2));
        pointDaoService.save(new Point("Петербургские аптеки", "Невский просп., 50",59.934592, 30.334778,2));

...
public class AdminServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        pointDaoService.save(new Point("Софосбувир СПб", "Клинский просп., 21",59914669, 30321186,2 ));
        pointDaoService.save(new Point("Синофарм СПб Китайская медицина","наб. Обводного канала, 92, эт. 1, оф. 102-2",59908638, 30322031,2));
        pointDaoService.save(new Point("Петрофарм","Большая Конюшенная ул., 14",59936341, 30322866,2));
        pointDaoService.save(new Point("Петербургские аптеки", "Невский просп., 50",59934592, 30334778,2));

            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="${pageContext.servletContext.contextPath}/admin/points/delete?id=${point.getId()}">Delete</a>
                        <%--<button type="button" class="btn btn-defaul" rel="${pageContext.servletContext.contextPath}/admin/points/edit?id=${point.getTypeId()}" >Edit</button>--%>
                        <%--<button type="button" class="btn btn-defaul" rel="${pageContext.servletContext.contextPath}/admin/points/delete?id=${point.getTypeId()}" >Delete</button>--%>
                </td>
            </tr>
            </tbody>
        </c:forEach>
